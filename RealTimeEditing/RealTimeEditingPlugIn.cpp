// RealTimeEditingPlugIn.cpp : defines the initialization routines for the plug-in.
//
...
RHINO_PLUG_IN_NAME(L"RealTimeEditing");

// Rhino plug-in id
// Provide a unique uuid for this plug-in.
RHINO_PLUG_IN_ID(L"E59D6116-735B-4C96-8F9B-38E590601E5A");
...
RHINO_PLUG_IN_DESCRIPTION(L"RealTimeEditing plug-in for Rhinoceros®");
...
// The one and only CRealTimeEditingPlugIn object
static class CRealTimeEditingPlugIn thePlugIn;

/////////////////////////////////////////////////////////////////////////////
// CRealTimeEditingPlugIn definition

CRealTimeEditingPlugIn& RealTimeEditingPlugIn()
{
	// Return a reference to the one and only CRealTimeEditingPlugIn object
	return thePlugIn;
}

CRealTimeEditingPlugIn::CRealTimeEditingPlugIn()
{
	// Description:
	//   CRealTimeEditingPlugIn constructor. The constructor is called when the
	//   plug-in is loaded and "thePlugIn" is constructed. Once the plug-in
	//   is loaded, CRealTimeEditingPlugIn::OnLoadPlugIn() is called. The
...
const wchar_t* CRealTimeEditingPlugIn::PlugInName() const
{
	// Description:
...
const wchar_t* CRealTimeEditingPlugIn::PlugInVersion() const
{
	// Description:
...
GUID CRealTimeEditingPlugIn::PlugInID() const
{
	// Description:
	...
	// {E59D6116-735B-4C96-8F9B-38E590601E5A}
...
BOOL CRealTimeEditingPlugIn::OnLoadPlugIn()
{
	// Description:
...
void CRealTimeEditingPlugIn::OnUnloadPlugIn()
{
	// Description:
